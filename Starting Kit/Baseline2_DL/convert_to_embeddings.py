...
def TextDataToEmbedding(inputfile,outputfile,isEvaluation,isTrain,isValidation):
    ...
    for line in f:
        ...
        fw.write(query_id + "\t" + query_feature_vector + "\t" +passage_feature_vector+"\t" + label + "\n")
...
if __name__ == "__main__":
    ...
    TextDataToEmbedding(trainFileName,"TrainDataWithEmbeddings.tsv",False,True,False)
    print("Train Data conversion is done")
    TextDataToEmbedding(validationFileName,"ValidationDataWithEmbeddings.tsv",False,False,True)
    print("Validation Data conversion is done")
    TextDataToEmbedding(EvaluationFileName,"EvaluationDataWithEmbeddings.tsv",True,False,False)
